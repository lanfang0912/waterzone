      ...
      <div className="max-w-3xl mx-auto px-6 pt-8 pb-0">
        <div className="flex flex-col gap-3">
          <a
            ...
            className="flex items-center justify-center gap-2 w-full bg-[#06C755] hover:bg-[#05b34c]
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-2 w-full bg-[#1877F2] hover:bg-[#166fe5]
                       text-white text-sm font-medium px-4 py-3 rounded-2xl transition-colors"
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
